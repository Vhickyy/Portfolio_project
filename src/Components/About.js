    ...
    <div className='bg-yellow-900 py-[7rem] min-h-[100vh] flex flex-col justify-center'>
        <div className='w-[90%] mx-auto grid gap-[2rem]'>
            ...
            <div className='grid gap-[1rem] text-xl text-yellow-200'>
                <p>Kelechi A. Okorie is a Canva Creative Designer with over two years of experience and has taught a lot of people are to create awesome designs and land their dream job.</p>
